...
<script>
  // Function to set today's date as the default for arrivalDate
  ...
  function autoSaveToLocalStorage() {
    ...
    const bookingData = { arrivalDate, departureDate, guests };
    localStorage.setItem('bookingData', JSON.stringify(bookingData));
  }

  // Attach 'input' event listeners to automatically save data
  document.getElementById('arrivalDate').addEventListener('input', autoSaveToLocalStorage);
  document.getElementById('departureDate').addEventListener('input', autoSaveToLocalStorage);
  document.getElementById('guests').addEventListener('input', autoSaveToLocalStorage);

  // Load data on page load and set default dates
